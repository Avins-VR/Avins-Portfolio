...
function Project() {
  const [projects] = useState([
    ...
    },
    {
      title: "Safeguard",
      date: "2025",
      description: "Safeguard is a safety application focused on real-time protection, featuring emergency alerts, location tracking, and instant communication to empower users and create safer communities.",
      image: Safegaurd,
      tech: ['Tailwind CSS', 'JavaScript', 'React', 'API Integration'],
      demo: "https://safegaurd-seven.vercel.app/",
